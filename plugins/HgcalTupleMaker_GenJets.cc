...
HgcalTupleMaker_GenJets::HgcalTupleMaker_GenJets(const edm::ParameterSet& iConfig) :
...
produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  if( !iEvent.isRealData() ) {
    ...
    if( genJets.isValid() ) {
      edm::LogInfo("HgcalTupleMaker_GenJetsInfo") << "Total # GenJets: " << genJets->size();
      ...
      edm::LogError("HgcalTupleMaker_GenJetsError") << "Error! Can't get the product " << inputTag;
    }
  }
