...
HgcalTupleMaker_Vertex::HgcalTupleMaker_Vertex(const edm::ParameterSet& iConfig) :
...
produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  ...
  if(primaryVertices.isValid()) {
    edm::LogInfo("HgcalTupleMaker_VertexInfo") << "Total # Primary Vertices: " << primaryVertices->size();
    ...
    edm::LogError("HgcalTupleMaker_VertexError") << "Error! Can't get the product " << inputTag;
  }
