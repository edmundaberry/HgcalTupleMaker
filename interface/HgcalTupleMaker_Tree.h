#ifndef HgcalTupleMaker_Tree_h
#define HgcalTupleMaker_Tree_h
...
class HgcalTupleMaker_Tree : public edm::EDAnalyzer {
 private:
 ...
 public:
  explicit HgcalTupleMaker_Tree(const edm::ParameterSet& iConfig) : pset(iConfig) {}
