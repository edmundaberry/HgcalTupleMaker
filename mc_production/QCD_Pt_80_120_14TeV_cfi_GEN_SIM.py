...
# with command line options: QCD_Pt_80_120_14TeV_cfi --conditions auto:upgradePLS3 -n 100 --eventcontent FEVTDEBUG --relval 9000,100 -s GEN,SIM --datatier GEN-SIM --beamspot Gauss --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2023HGCalMuon --magField 38T_PostLS1 --geometry Extended2023HGCalV4Muon,Extended2023HGCalV4MuonReco --fileout file:step1.root --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('QCD_Pt_80_120_14TeV_cfi nevts:100'),
