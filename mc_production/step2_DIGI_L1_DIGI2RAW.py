...
# with command line options: step2 --conditions auto:upgradePLS3 -n 10 --eventcontent FEVTDEBUGHLT -s DIGI:pdigi_valid,L1,DIGI2RAW --datatier GEN-SIM-DIGI-RAW --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2023HGCalMuon --magField 38T_PostLS1 --geometry Extended2023HGCalV4Muon,Extended2023HGCalV4MuonReco --filein file:step1.root --fileout file:step2.root --no_exec
